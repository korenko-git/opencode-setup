---
name: "auth"
description: "Google OAuth authentication flow with JWT, user tables, FastAPI dependencies, and React auth state. Invoke when adding login, auth routes, or protected endpoints."
---
